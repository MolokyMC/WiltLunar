...
extends Gui {
    ...
    private int field_146222_t = 0xE0E0E0;
    ...
    public void drawTextBox() {
        if (this.func_146176_q()) {
            if (this.func_146181_i()) {
                Gui.drawRect((int)(this.field_146209_f - 1), (int)(this.field_146210_g - 1), (int)(this.field_146209_f + this.field_146218_h + 1), (int)(this.field_146210_g + this.field_146219_i + 1), (int)-6250336);
                Gui.drawRect((int)this.field_146209_f, (int)this.field_146210_g, (int)(this.field_146209_f + this.field_146218_h), (int)(this.field_146210_g + this.field_146219_i), (int)-16777216);
            }
            ...
            if (var6) {
                if (var11) {
                    Gui.drawRect((int)var12, (int)(var8 - 1), (int)(var12 + 1), (int)(var8 + 1 + this.field_146211_a.FONT_HEIGHT), (int)-3092272);
                } else {
                    this.field_146211_a.drawString("_", var12, var8, var1);
                }
            }
            if (var3 != var2) {
                int var13 = var7 + this.field_146211_a.getStringWidth(var4.substring(0, var3).replaceAll("\\.", "*"));
    ...
    private void func_146188_c(int p_146188_1_, int p_146188_2_, int p_146188_3_, int p_146188_4_) {
        ...
        ((IMixinWorldRenderer)var6).startDrawingQuads();
    ...
    public void func_146191_b(String p_146191_1_) {
        int var7;
        String var2 = "";
        String var3 = ChatAllowedCharacters.filterAllowedCharacters((String)p_146191_1_);
    ...
    public boolean textboxKeyTyped(char p_146201_1_, int p_146201_2_) {
        ...
        switch (p_146201_1_) {
            ...
            case '\u0003': {
                GuiScreen.setClipboardString((String)this.func_146207_c());
                return true;
            }
            case '\u0016': {
